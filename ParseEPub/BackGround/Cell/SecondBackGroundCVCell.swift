...
class SecondBackGroundCVCell: UICollectionViewCell {
    var colorHex = ""
    ...
    func setTitleLabelConstraints(){
        ...
        NSLayoutConstraint.activate([
            titleLabel.widthAnchor.constraint(equalToConstant: fullScreenX * 0.22),
    ...
    func setShadowViewConstraints(){
        ...
        NSLayoutConstraint.activate([
            shadowView.widthAnchor.constraint(equalToConstant: fullScreenX * 0.24),
